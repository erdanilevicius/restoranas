<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        ...
        <h1
            ...
            <span class="inline md:block">Random Restoranas</span>
        </h1>
    ...
    <section class="px-2 py-32 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        <h3 class="text-xl">Mūsų istorija
                        </h3>
                        <h2 class="text-4xl text-green-600">Sveiki</h2>
                        <!-- </h1> -->
                    ...
                    <div class="w-full lg:max-w-md">
                        ...
                        <ul>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Greičiausias patvirtinimas</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Greiti susimokėjimai</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <svg class="w-8 h-8 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg">
    ...
    @if(is_array($specials))
        <section class="mt-8 bg-white">
            <div class="mt-4 text-center">
                <h3 class="text-2xl font-bold">Mūsų meniu</h3>
                <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                    Šiandienos specialūs</h2>
            </div>
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        ...
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                ...
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Maistas</h2>
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Rick Astley</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Random Bičas</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                ...
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Nežinia Kas</a>
                </div>
            </div>
        </div>
    </section>
